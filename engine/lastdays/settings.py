...
WSGI_APPLICATION = 'lastdays.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgresql://localhost/lastdays", conn_max_age=500)
}
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "ROUTING": "lastdays.routing.channel_routing",
    },
}
